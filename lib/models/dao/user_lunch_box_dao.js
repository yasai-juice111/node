...
UserLunchBoxDao.prototype.add = function(req, params, callback) {
	...
	var queryString = 'insert into user_lunch_box (user_id, lunch_box_id, receive_flag, insert_datetime, update_datetime) value (?,?,?,?,?)';
...
UserLunchBoxDao.prototype.updateCancelFlag = function(req, params, callback) {
	...
	var queryString = 'update user_lunch_box set cancel_flag = true where id = ? and update_datetime = ?';
	mysql.query(queryString, addData, callback);
